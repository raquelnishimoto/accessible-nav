export const messages = {
    ABOUT_ME: `
    Hey there, cyber wanderer! 🚀 Welcome to the virtual abode I call my own. I'm thrilled you've landed on this little patch of cyberspace amidst the vast digital cosmos. So, who am I? Well, think of me as your digital sherpa, navigating the peaks and valleys of pixels and code with equal parts enthusiasm and curiosity.
    ...
    So, pull up a digital chair, pour yourself a cup of virtual coffee, and let's embark on an adventure unlike any other. The internet is our playground, and the possibilities are as endless as the stars in the digital sky. Let's dive in and make some memories – one pixel at a time. 💫
    `,
    ...
    As the final note hung in the air, a collective sigh swept through the room, followed by thunderous applause that reverberated off the walls. In that instant, I knew that this was where I belonged – on stage, sharing my love of music with the world.
